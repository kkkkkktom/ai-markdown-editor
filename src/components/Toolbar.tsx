import { Button, Space, Dropdown, Upload, Tooltip, type MenuProps, message, Modal, Table, Input } from "antd";
import {
  FileAddOutlined,
  SaveOutlined,
  DownloadOutlined,
    ...
    <>
      ...
      >
        <Space>
          ...
          {/* 🧭 Markdown 指南 */}
          <Tooltip title="查看 Markdown 使用说明" placement="top" mouseEnterDelay={0.3}>
            <Button icon={<BookOutlined />} onClick={() => setIsGuideVisible(true)} />
          </Tooltip>
        </Space>
      ...
      >
        <Table
          ...
          dataSource={[
            ...
            { key: 2, func: "加粗", syntax: "**加粗文本**", shortcut: "Ctrl / ⌘ + B" },
            { key: 3, func: "斜体", syntax: "*斜体文本*", shortcut: "Ctrl / ⌘ + I" },
            { key: 4, func: "链接", syntax: "[文字](https://example.com)", shortcut: "-" },
            { key: 5, func: "任务列表", syntax: "- [ ] 待办事项", shortcut: "-" },
            { key: 6, func: "表格", syntax: "| 列1 | 列2 |\n| --- | --- |", shortcut: "-" },
            { key: 7, func: "代码块", syntax: "```js\nconsole.log('Hi')\n```", shortcut: "Ctrl / ⌘ + Shift + C" },
          ...
          columns={[
            ...
            { title: "快捷键", dataIndex: "shortcut", key: "shortcut", width: 160 },
          ]}
        />
      </Modal>
